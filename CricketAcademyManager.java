...
public class CricketAcademyManager implements Serializable {
    ...
    public void addPractice(String playerName, CourseType courseType, int durationInMinutes) {
        MatchPractice practice = new MatchPractice(playerName, courseType, durationInMinutes);
